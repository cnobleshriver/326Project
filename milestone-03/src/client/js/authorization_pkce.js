...
const clientId = 'd438496e304746c49414f6282f0a9477'; // your clientId
...
// If we have a token, we're logged in, so fetch user data and render logged in state
if (currentToken.access_token) {
  const userData = await getUserData();
  // render the logout button and user data
}

// Otherwise we're not logged in, so render the login button
if (!currentToken.access_token) {
